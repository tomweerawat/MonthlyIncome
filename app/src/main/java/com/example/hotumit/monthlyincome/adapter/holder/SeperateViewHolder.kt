...
import kotlinx.android.synthetic.main.income_view_row.view.*
import kotlinx.android.synthetic.main.sum_income_view_row.view.*


class SeperateViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
    /*   val image: ImageView = itemView.img*/


    fun codeName(codeName: String) {
        itemView.transactiondatetime.text = codeName
    }

    fun billaddress(billaddress: String) {
        itemView.billaddress.text = billaddress
    }
