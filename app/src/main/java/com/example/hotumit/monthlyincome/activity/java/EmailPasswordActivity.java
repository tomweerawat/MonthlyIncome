...
public class EmailPasswordActivity extends BaseActivity implements View.OnClickListener {
	...
	private void initFirebase() {
		...
		mAuthListener = new FirebaseAuth.AuthStateListener() {
			...
			public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
				...
				if (user != null) {
					Log.d(TAG, "onAuthStateChanged:signed_in:" + user.getUid()+"\t"+"MyToken "+user.getIdToken(true));
	...
	private void initSharedPreferences(FirebaseUser user){
		Log.e("startshareprederences","startshareprederences"+user.getEmail());
		SharedPreferences.Editor editor = pref.edit();
		editor.putString(Constanst.EMAIL,user.getEmail());
		editor.putString(Constanst.UNIQUE_ID, user.getUid());
		editor.putString(Constanst.NAME, user.getDisplayName());
		editor.putString(Constanst.USERIMAGE, String.valueOf(user.getPhotoUrl()));
		editor.apply();
	}
...
signOut();
	...
	private void gotoActivity(){
		Intent i = new Intent(EmailPasswordActivity.this,ActivityChooseDate.class);
		startActivity(i);
	}
